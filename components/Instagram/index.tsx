                ...
                <div className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
                    <div className="col-span-6 text-center lg:text-left">
                        ...
                        <p className="mb-4 max-w-xl text-gray-500 dark:text-gray-400">
                            Gelecek için bir adım...
                        </p>
                        <div className="flex items-center justify-center space-x-4 lg:justify-start">
                            <Link prefetch={true} href="apply" rel="noopener noreferrer" className="text-sm font-medium underline underline-offset-4 text-black dark:text-gray-300 hover:no-underline">
                                Apply Nedir?
                            </Link>
